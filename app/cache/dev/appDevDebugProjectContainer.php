...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'vfldepr', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string'));
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\Acme\\BlogBundle\\Resources\\config\\doctrine') => 'Acme\\BlogBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Acme\\BlogBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('AcmeBlogBundle' => 'Acme\\BlogBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Acme\\AppBundle/Resources/views'), 'AcmeApp');
        $instance->addPath(($this->targetDirs[3].'\\src\\Acme\\BlogBundle/Resources/views'), 'AcmeBlog');
        $instance->addPath(($this->targetDirs[3].'\\src\\Acme\\AdminBundle/Resources/views'), 'AcmeAdmin');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('7db432e8e830ebee2609d7f5f1f5d3b3bbba8f93');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AcmeAppBundle' => 'Acme\\AppBundle\\AcmeAppBundle',
            ...
            'locale' => 'en',
            'secret' => '7db432e8e830ebee2609d7f5f1f5d3b3bbba8f93',
            ...
            'kernel.secret' => '7db432e8e830ebee2609d7f5f1f5d3b3bbba8f93',
